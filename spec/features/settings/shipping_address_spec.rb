  ...
  context 'with correct data' do
    it 'creates shipping address' do
      ...
      settings_page.shipping_address do |shipping|
        expect(shipping.first_name.value).to eq(first_name)
        expect(shipping.last_name.value).to eq(last_name)
        expect(shipping.address.value).to eq(address)
        expect(shipping.city.value).to eq(city)
        expect(shipping.zip.value).to eq(zip)
        expect(shipping.country.value).to eq(country)
        expect(shipping.phone.value).to eq(phone)
      end
    end
  end
